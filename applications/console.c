...
static rt_ssize_t _console_dev_read(rt_device_t dev, rt_off_t pos, void *buffer, rt_size_t size)
{
    if (size == 0)
        return 0;
...
static rt_ssize_t _console_dev_write(rt_device_t dev, rt_off_t pos, const void *buffer, rt_size_t size)
{
    if (size == 0)
        return 0;
